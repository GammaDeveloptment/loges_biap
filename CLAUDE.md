...
> - 012-B — Cumplimiento Legal de Fuentes (v0.8): redactado por Claude Code como **marco metodológico, no como opinión legal** (Claude Code no puede generar conclusiones legales verificadas por país). Define checklist de evaluación por fuente (acceso público, términos de uso, datos personales vs. corporativos, normativa aduanera, límites de uso), plantilla de registro, y gobernanza (aprobación por persona designada por Gammacargo con respaldo legal real, nunca por el equipo de desarrollo). **El cliente designó a Ricardo Ortega Silva como esa persona el 2026-08-18** — resuelve el "quién", pero ninguna fuente candidata del Documento 012 tiene todavía una fila "Aprobada" completa, así que esto sigue bloqueando la Entrega 2 (y ahora también 3 y 6) hasta que esa evaluación real se ejecute, no solo se nombre a quien la hará.
